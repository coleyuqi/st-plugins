...
1. 下载两个 `.js` 文件，放进 SillyTavern 的插件目录：
   ...
   - Termux（手机本地跑 ST）示例：
     ```bash
     cp "/storage/emulated/0/npc-register.js" ~/SillyTavern/public/scripts/extensions/third-party/
     cp "/storage/emulated/0/preset-summary.js" ~/SillyTavern/public/scripts/extensions/third-party/
     ```
